...
- `pytest` passes
- If model artifacts changed: REPORT.md and `models/ensemble_final/config.json` updated
- If schema changed: MODEL_CARD.md, DATA_CARD.md, README.md updated
...
3. If it beats current ensemble: add to `models/ensemble_final/config.json`, re-run `src/eval_ensemble_on_test.py`, document in CHANGELOG.
